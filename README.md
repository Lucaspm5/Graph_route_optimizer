...
```bash
git clone https://github.com/seu-usuario/orienteering-rio.git
cd orienteering-rio
```
...
O programa espera um arquivo CSV com o formato:

```csv
id,nome,latitude,longitude,pontuacao
1,Cristo Redentor,-22.9519,-43.2105,5479
2,Pão de Açúcar,-22.9490,-43.1541,4110
3,Praia de Copacabana,-22.9708,-43.1822,9589
...
```
